...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback,
        GoogleApiClient.OnConnectionFailedListener, RoutingListener, onRoutingFailure {
...
//        Findroutes(start,end);
    ...
    private void sendRoutePointsToSQS(List<LatLng> routePoints, final String LOG_TAG, Collator AWSMobileClient) {
        AmazonSQSAsyncClient sqs = new AmazonSQSAsyncClient(AWSMobileClient.getInstance());
        sqs.setRegion(getString("us_east_1"));
        ...
        for (String point : formattedPoints) {
            SendMessageRequest req = new SendMessageRequest("https://sqs.us-east-1.amazonaws.com/542055976717/fila_sqs_android", point);
    ...
    private String getString(String us_east_1) {
        return null;
    }
